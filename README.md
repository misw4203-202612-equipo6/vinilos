...
Esta aplicación consta de una aplicación móvil Android desarrollada con Kotlin y Jetpack Compose, y un backend desarrollado con NestJS.
...
El backend está desarrollado con NestJS y se construye utilizando contenedores Docker.
...
2. Construye y ejecuta los contenedores usando Docker Compose:
   ...
   Esto iniciará el servidor backend en el puerto 3000 y la base de datos PostgreSQL en el puerto 5432.

3. Una vez que los contenedores estén ejecutándose, el backend estará disponible en `http://localhost:3000`.
